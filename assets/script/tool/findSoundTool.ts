...
export class findSoundTool {
    ...
    constructor() {
        this.musicSwitch = findStorage.getBoolByKey("kk_setup_music", true);
        this.effectSwitch = findStorage.getBoolByKey("kk_setup_effect", true);
        this.shockSwitch = findStorage.getBoolByKey("kk_setup_shock", true);
    }

    public switchMusic(): void {
        this.musicSwitch = !this.musicSwitch;
        findStorage.setBoolByKey("kk_setup_music", this.musicSwitch);
        if (this.musicSwitch) {
            if (this.currMusic) {
    ...
    public switchEffect(): void {
        ...
        findStorage.setBoolByKey("kk_setup_effect", this.effectSwitch);
    ...
    public switchShock(): void {
        ...
        findStorage.setBoolByKey("kk_setup_shock", this.shockSwitch);
    }
